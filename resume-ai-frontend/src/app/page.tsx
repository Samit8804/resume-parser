    ...
    <div className="min-h-screen bg-ink">
      ...
      >
        <div className="flex items-center justify-between h-16 px-6 max-w-6xl mx-auto">
          <Link href="/" className="font-display text-xl text-paper tracking-tight">
            ResumeRank AI
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/register"
              className="text-sm px-4 py-2 rounded-lg bg-signal-amber text-ink font-medium hover:brightness-110 transition-all"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="relative">
          <div className="animate-blur-in">
            <JitterHeadline
              ...
              className="text-5xl md:text-7xl lg:text-8xl text-paper mb-4"
            />
            <JitterHeadline
              text="Not just the ranking."
              as="h2"
              className="text-4xl md:text-6xl lg:text-7xl text-signal-amber mb-8"
            />
          </div>
          ...
          <div className="flex items-center justify-center gap-4 animate-fade-up" style={{ animationDelay: "0.5s" }}>
            <Link
              href="/register"
              className="px-6 py-3 rounded-xl bg-signal-amber text-ink font-semibold hover:brightness-110 transition-all glow-amber"
            >
              Start Hiring Smarter
            </Link>
            <a
              href="#how-it-works"
              className="px-6 py-3 rounded-xl glass text-paper/80 hover:text-paper transition-all"
            >
              See How It Works
            </a>
          </div>
              ...
              frostContent={
                <div className="flex items-center justify-center h-full">
                  <div className="text-center">
                    <p className="text-6xl font-mono font-semibold text-paper/40" style={{ filter: "blur(4px)" }}>
                      94%
                    </p>
      ...
      <section id="product" className="py-24 px-4 max-w-5xl mx-auto">
        <div className="section-reveal text-center">
          ...
          <p className="text-paper/50 max-w-lg mx-auto mb-8">
            A dashboard built for speed. Create jobs, review candidates, compare side-by-side,
            send emails, and track your pipeline — all in one place.
          </p>
        </div>
        <div className="section-reveal">
          <GlassCard glow className="p-0 overflow-hidden">
            ...
            <div className="p-8 text-center text-paper/30 text-sm">
              Dashboard mockup — ResumeRank AI interface
            </div>
          </GlassCard>
        </div>
      </section>
      ...
      <section className="pb-32 pt-8 px-4 max-w-3xl mx-auto text-center section-reveal">
        <GlassCard glow className="py-16">
          ...
          <p className="text-paper/50 mb-8 max-w-md mx-auto">
            Stop guessing why candidates scored what they did. Start hiring with clarity.
          </p>
          <Link
            href="/register"
            className="inline-block px-8 py-4 rounded-xl bg-signal-amber text-ink font-semibold hover:brightness-110 transition-all glow-amber"
          >
            Get Started Free
          </Link>
        </GlassCard>
